...
export const Home: React.FC = () => {
  ...
  const [chats, setChats] = React.useState([
    ...
    { text: "용주 님, 안녕하세요! 무엇을 도와드릴까요?", posLeft: true },
      ...
      <div className={styles.micWrapper}>
        <div
          ...
          onClick={async () => {
            ...
            const res = await fetch("http://127.0.0.1:8000/character", { //"http://192.168.100.104:80/character"
              method: "POST",
              mode: "cors",
              headers: {
            ...
            console.log("var", json.var)
            console.log("response", json.contents);

            setChats((currChats) => [
              ...currChats,
              transcript === ""
                ? { text: transcript, posLeft: true } // "목소리가 잘 들리지 않아요."
